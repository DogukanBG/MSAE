...
DT="/BS/disentanglement/work/sae/imagenet_dinov2_vitb14_embeddings_train.npy"
DS="/BS/disentanglement/work/sae/imagenet_dinov2_vitb14_embeddings_val.npy"
EPOCHS=20
